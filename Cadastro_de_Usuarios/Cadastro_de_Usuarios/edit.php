...
<head>
    ...
    <title>Edição de Cadastro de Usuários</title>
</head>

<body>
    <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00ff5573;">
        Ediçaõ de Cadastro de Usuários
    </nav>

    <div class="container">
        <div class="text-center mb-4">
            <h3>Edite os Dados do Usuário</h3>
            <p class="text-muted">Clique em "Salvar" para atualizar os dados</p>
        </div>
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width: 50vw; min-width: 300px">
                ...
                <div class="forn-group mb-3">
                    ...
                    &nbsp;
                    <input type="radio" class="form-check-label" name="gender" id="female" value="Feminino" <?php echo ($row['gender'] == 'female') ? "checked" : ""; ?>>
